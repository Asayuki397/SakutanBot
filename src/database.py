...
cur.execute("CREATE TABLE IF NOT EXISTS ARiSA_db (name VARCHAR(255),id BIGINT, guild_id BIGINT, lvl INT DEFAULT 1, exp INT DEFAULT 0, money BIGINT DEFAULT 50000, loss BIGINT DEFAULT 0, dailybonus INT DEFAULT 0)")
cur.execute("CREATE TABLE IF NOT EXISTS ARiSA_stocks (name VARCHAR(255), id BIGINT, guild_id BIGINT, AKKN BIGINT DEFAULT 0, AKKNavg BIGINT DEFAULT 0, SHRN BIGINT DEFAULT 0, SHRNavg BIGINT DEFAULT 0, STND BIGINT DEFAULT 0, STNDavg BIGINT DEFAULT 0, UMSI BIGINT DEFAULT 0, UMSIavg BIGINT DEFAULT 0)")
cur.execute("CREATE TABLE IF NOT EXISTS ARiSA_guilds (name VARCHAR(255), id BIGINT, on_member_join BOOLEAN DEFAULT TRUE, on_guild_join BOOLEAN DEFAULT TRUE, on_member_remove BOOLEAN DEFAULT TRUE)")
